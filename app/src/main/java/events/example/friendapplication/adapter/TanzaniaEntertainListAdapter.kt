...
import events.app.friendapplication.TanzaniaEntertainDetailsActivity
import events.app.friendapplication.model.TanzaniaEntertain
import events.app.friendapplication.uitel.loadImage


class TanzaniaEntertainListAdapter (var mContext: Context, var tanzaniaentertainList:List<TanzaniaEntertain>):
    RecyclerView.Adapter<TanzaniaEntertainListAdapter.ListViewHolder>()
{
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ListViewHolder {
        ...
        val v = inflater.inflate(R.layout.tanzania_entertain_item,parent,false)
        return ListViewHolder(v)
    }

    override fun onBindViewHolder(holder: ListViewHolder, position: Int) {
        val newList = tanzaniaentertainList[position]
        ...
        holder.v.setOnClickListener {
            ...
            val mIntent = Intent(mContext, TanzaniaEntertainDetailsActivity::class.java)
    ...
    override fun getItemCount(): Int = tanzaniaentertainList.size
}
