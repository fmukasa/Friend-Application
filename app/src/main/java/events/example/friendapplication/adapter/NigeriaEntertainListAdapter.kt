...
import events.app.friendapplication.NigeriaEntertainDetailsActivity
...
class NigeriaEntertainListAdapter (var mContext: Context, var nigeriaentertainList:List<NigeriaEntertain>):
    RecyclerView.Adapter<NigeriaEntertainListAdapter.ListViewHolder>()
{
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ListViewHolder {
        ...
        val v = inflater.inflate(R.layout.nigeria_entertain_item,parent,false)
        return ListViewHolder(v)
    }

    override fun onBindViewHolder(holder: ListViewHolder, position: Int) {
        val newList = nigeriaentertainList[position]
        ...
        holder.v.setOnClickListener {
            ...
            val mIntent = Intent(mContext, NigeriaEntertainDetailsActivity::class.java)
    ...
    override fun getItemCount(): Int = nigeriaentertainList.size
}
