...
import events.app.friendapplication.NigeriaEstateDetailsActivity
import events.app.friendapplication.R
import events.app.friendapplication.model.NigeriaEstate
import events.app.friendapplication.uitel.loadImage


class NigeriaEstateListAdapter (var mContext: Context, var nigeriaestateList:List<NigeriaEstate>):
    RecyclerView.Adapter<NigeriaEstateListAdapter.ListViewHolder>()
{
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ListViewHolder {
        ...
        val v = inflater.inflate(R.layout.nigeria_estate_item,parent,false)
        return ListViewHolder(v)
    }

    override fun onBindViewHolder(holder: ListViewHolder, position: Int) {
        val newList = nigeriaestateList[position]
        ...
        holder.v.setOnClickListener {
            ...
            val mIntent = Intent(mContext, NigeriaEstateDetailsActivity::class.java)
    ...
    override fun getItemCount(): Int = nigeriaestateList.size
}
