...
import events.app.friendapplication.NigeriaDirectorDetailsActivity
...
class NigeriaDirectorListAdapter (var mContext: Context, var nigeriadirectorList:List<NigeriaDirector>):
    RecyclerView.Adapter<NigeriaDirectorListAdapter.ListViewHolder>()
{
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ListViewHolder {
        ...
        val v = inflater.inflate(R.layout.nigeria_director_item,parent,false)
        return ListViewHolder(v)
    }

    override fun onBindViewHolder(holder: ListViewHolder, position: Int) {
        val newList = nigeriadirectorList[position]
        ...
        holder.v.setOnClickListener {
            ...
            val mIntent = Intent(mContext, NigeriaDirectorDetailsActivity::class.java)
    ...
    override fun getItemCount(): Int = nigeriadirectorList.size
}
