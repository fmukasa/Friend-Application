...
import events.app.friendapplication.ServiceDetailsActivity
import events.app.friendapplication.model.Service
import events.app.friendapplication.uitel.loadImage


class ServiceListAdapter (var mContext: Context, var serviceList:List<Service>):
    RecyclerView.Adapter<ServiceListAdapter.ListViewHolder>()
{
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ListViewHolder {
        ...
        val v = inflater.inflate(R.layout.service_item,parent,false)
        return ListViewHolder(v)
    }

    override fun onBindViewHolder(holder: ListViewHolder, position: Int) {
        val newList = serviceList[position]
        ...
        holder.v.setOnClickListener {
            ...
            val mIntent = Intent(mContext, ServiceDetailsActivity::class.java)
