...
import events.app.friendapplication.NigeriaDetailsActivity
...
class NigeriaListAdapter (var mContext: Context, var nigeriaList:List<Nigeria>):
    RecyclerView.Adapter<NigeriaListAdapter.ListViewHolder>()
{
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ListViewHolder {
        ...
        val v = inflater.inflate(R.layout.nigeria_item,parent,false)
        return ListViewHolder(v)
    }

    override fun onBindViewHolder(holder: ListViewHolder, position: Int) {
        val newList = nigeriaList[position]
        ...
        holder.v.setOnClickListener {
            ...
            val mIntent = Intent(mContext, NigeriaDetailsActivity::class.java)
    ...
    override fun getItemCount(): Int = nigeriaList.size
}
