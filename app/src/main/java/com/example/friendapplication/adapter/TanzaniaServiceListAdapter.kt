...
import com.example.friendapplication.KenyaServiceDetailsActivity
import com.example.friendapplication.R
import com.example.friendapplication.TanzaniaServiceDetailsActivity
...
class TanzaniaServiceListAdapter  (var mContext: Context, var tanzaniaserviceList:List<TanzaniaService>):
    RecyclerView.Adapter<TanzaniaServiceListAdapter.ListViewHolder>()
{
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ListViewHolder {
        ...
        val v = inflater.inflate(R.layout.tanzania_service_item,parent,false)
        return ListViewHolder(v)
    }

    override fun onBindViewHolder(holder: ListViewHolder, position: Int) {
        val newList = tanzaniaserviceList[position]
        ...
        holder.v.setOnClickListener {
            ...
            val mIntent = Intent(mContext, TanzaniaServiceDetailsActivity::class.java)
    ...
    override fun getItemCount(): Int = tanzaniaserviceList.size
}
