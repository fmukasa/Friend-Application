...
import com.example.friendapplication.KenyaFoundDetailsActivity
import com.example.friendapplication.R
import com.example.friendapplication.TanzaniaFoundDetailsActivity
...
class TanzaniaFoundListAdapter (var mContext: Context, var tanzaniafoundList:List<TanzaniaFound>):
    RecyclerView.Adapter<TanzaniaFoundListAdapter.ListViewHolder>()
{
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ListViewHolder {
        ...
        val v = inflater.inflate(R.layout.tanzania_found_item,parent,false)
        return ListViewHolder(v)
    }

    override fun onBindViewHolder(holder: ListViewHolder, position: Int) {
        val newList = tanzaniafoundList[position]
        ...
        holder.v.setOnClickListener {
            ...
            val mIntent = Intent(mContext, TanzaniaFoundDetailsActivity::class.java)
    ...
    override fun getItemCount(): Int = tanzaniafoundList.size
}
