...
import com.example.friendapplication.SoundDetailsActivity
...
class SoundListAdapter (var mContext: Context, var soundList:List<Sound>):
    RecyclerView.Adapter<SoundListAdapter.ListViewHolder>()
{
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ListViewHolder {
        ...
        val v = inflater.inflate(R.layout.sound_item,parent,false)
        return ListViewHolder(v)
    }

    override fun onBindViewHolder(holder: ListViewHolder, position: Int) {
        val newList = soundList[position]
        ...
        holder.v.setOnClickListener {
            ...
            val mIntent = Intent(mContext, SoundDetailsActivity::class.java)
