...
class NigeriaServiceListAdapter (var mContext: Context, var nigeriaserviceList:List<NigeriaService>):
    RecyclerView.Adapter<NigeriaServiceListAdapter.ListViewHolder>()
{
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ListViewHolder {
        ...
        val v = inflater.inflate(R.layout.nigeria_service_item,parent,false)
        return ListViewHolder(v)
    }

    override fun onBindViewHolder(holder: ListViewHolder, position: Int) {
        val newList = nigeriaserviceList[position]
        ...
        holder.v.setOnClickListener {
            ...
            val mIntent = Intent(mContext, NigeriaServiceDetailsActivity::class.java)
    ...
    override fun getItemCount(): Int = nigeriaserviceList.size
}
