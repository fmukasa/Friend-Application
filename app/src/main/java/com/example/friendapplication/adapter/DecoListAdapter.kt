...
import com.example.friendapplication.DecoDetailsActivity
...
class DecoListAdapter (var mContext: Context, var decorationList:List<Decoration>):
    RecyclerView.Adapter<DecoListAdapter.ListViewHolder>()
{
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ListViewHolder {
        ...
        val v = inflater.inflate(R.layout.deco_row,parent,false)
        return ListViewHolder(v)
    }

    override fun onBindViewHolder(holder: ListViewHolder, position: Int) {
        val newList = decorationList[position]
        ...
        holder.v.setOnClickListener {
            ...
            val mIntent = Intent(mContext, DecoDetailsActivity::class.java)
    ...
    override fun getItemCount(): Int = decorationList.size
}