...
class KenyaWriterListAdapter  (var mContext: Context, var kenyawriterList:List<KenyaWriter>):
    RecyclerView.Adapter<KenyaWriterListAdapter.ListViewHolder>()
{
    ...
    override fun onBindViewHolder(holder: ListViewHolder, position: Int) {
        val newList = kenyawriterList[position]
        ...
        holder.v.setOnClickListener {
            ...
            val mIntent = Intent(mContext, KenyaWriterDetailsActivity::class.java)
    ...
    override fun getItemCount(): Int = kenyawriterList.size
}
