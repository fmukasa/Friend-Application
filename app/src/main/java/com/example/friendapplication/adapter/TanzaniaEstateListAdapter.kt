...
import com.example.friendapplication.KenyaEstateDetailsActivity
import com.example.friendapplication.R
import com.example.friendapplication.TanzaniaEstateDetailsActivity
...
class TanzaniaEstateListAdapter  (var mContext: Context, var tanzaniaestateList:List<TanzaniaEstate>):
    RecyclerView.Adapter<TanzaniaEstateListAdapter.ListViewHolder>()
{
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ListViewHolder {
        ...
        val v = inflater.inflate(R.layout.tanzania_estate_item,parent,false)
        return ListViewHolder(v)
    }

    override fun onBindViewHolder(holder: ListViewHolder, position: Int) {
        val newList = tanzaniaestateList[position]
        ...
        holder.v.setOnClickListener {
            ...
            val mIntent = Intent(mContext, TanzaniaEstateDetailsActivity::class.java)
    ...
    override fun getItemCount(): Int = tanzaniaestateList.size
}
