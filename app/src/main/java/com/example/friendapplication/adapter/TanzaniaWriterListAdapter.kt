...
import com.example.friendapplication.KenyaWriterDetailsActivity
import com.example.friendapplication.R
import com.example.friendapplication.TanzaniaWriterDetailsActivity
...
class TanzaniaWriterListAdapter  (var mContext: Context, var tanzaniawriterList:List<TanzaniaWriter>):
    RecyclerView.Adapter<TanzaniaWriterListAdapter.ListViewHolder>()
{
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ListViewHolder {
        ...
        val v = inflater.inflate(R.layout.kenya_writer_item,parent,false)
        return ListViewHolder(v)
    }

    override fun onBindViewHolder(holder: ListViewHolder, position: Int) {
        val newList = tanzaniawriterList[position]
        ...
        holder.v.setOnClickListener {
            ...
            val mIntent = Intent(mContext, TanzaniaWriterDetailsActivity::class.java)
    ...
    override fun getItemCount(): Int = tanzaniawriterList.size
}
