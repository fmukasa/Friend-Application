...
import com.example.friendapplication.KenyaEventDetailsActivity
import com.example.friendapplication.R
import com.example.friendapplication.TanzaniaEventDetailsActivity
...
class TanzaniaEventListAdapter (var mContext: Context, var tanzaniaeventList:List<TanzaniaEvent>):
    RecyclerView.Adapter<TanzaniaEventListAdapter.ListViewHolder>()
{
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ListViewHolder {
        ...
        val v = inflater.inflate(R.layout.tanzania_event_item,parent,false)
        return ListViewHolder(v)
    }

    override fun onBindViewHolder(holder: ListViewHolder, position: Int) {
        val newList = tanzaniaeventList[position]
        ...
        holder.v.setOnClickListener {
            ...
            val mIntent = Intent(mContext, TanzaniaEventDetailsActivity::class.java)
    ...
    override fun getItemCount(): Int = tanzaniaeventList.size
}
