...
import com.example.friendapplication.NigeriaWriterDetailsActivity
import com.example.friendapplication.R
import com.example.friendapplication.WriterDetailsActivity
...
class NigeriaWriterListAdapter  (var mContext: Context, var nigeriawriterList:List<NigeriaWriter>):
    RecyclerView.Adapter<NigeriaWriterListAdapter.ListViewHolder>()
{
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ListViewHolder {
        ...
        val v = inflater.inflate(R.layout.nigeria_writer_item,parent,false)
        return ListViewHolder(v)
    }

    override fun onBindViewHolder(holder: ListViewHolder, position: Int) {
        val newList = nigeriawriterList[position]
        ...
        holder.v.setOnClickListener {
            ...
            val mIntent = Intent(mContext, NigeriaWriterDetailsActivity::class.java)
    ...
    override fun getItemCount(): Int = nigeriawriterList.size
}
