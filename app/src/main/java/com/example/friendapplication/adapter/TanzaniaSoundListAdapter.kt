...
import com.example.friendapplication.KenyaSoundDetailsActivity
import com.example.friendapplication.R
import com.example.friendapplication.TanzaniaSoundDetailsActivity
...
class TanzaniaSoundListAdapter (var mContext: Context, var tanzaniasoundList:List<TanzaniaSound>):
    RecyclerView.Adapter<TanzaniaSoundListAdapter.ListViewHolder>()
{
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ListViewHolder {
        ...
        val v = inflater.inflate(R.layout.tanzania_sound_item,parent,false)
        return ListViewHolder(v)
    }

    override fun onBindViewHolder(holder: ListViewHolder, position: Int) {
        val newList = tanzaniasoundList[position]
        ...
        holder.v.setOnClickListener {
            ...
            val mIntent = Intent(mContext, TanzaniaSoundDetailsActivity::class.java)
    ...
    override fun getItemCount(): Int = tanzaniasoundList.size
}
