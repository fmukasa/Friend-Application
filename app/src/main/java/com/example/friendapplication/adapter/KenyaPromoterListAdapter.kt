...
import com.example.friendapplication.NigeriaPromoterDetailsActivity
...
class KenyaPromoterListAdapter (var mContext: Context, var kenyapromoterList:List<KenyaPromoter>):
    RecyclerView.Adapter<KenyaPromoterListAdapter.ListViewHolder>()
{
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ListViewHolder {
        ...
        val v = inflater.inflate(R.layout.kenya_promoter_item,parent,false)
        return ListViewHolder(v)
    }

    override fun onBindViewHolder(holder: ListViewHolder, position: Int) {
        val newList = kenyapromoterList[position]
        ...
        holder.v.setOnClickListener {
            ...
            val mIntent = Intent(mContext, KenyaPromoterDetailsActivity::class.java)
    ...
    override fun getItemCount(): Int = kenyapromoterList.size
}
