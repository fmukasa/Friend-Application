...
import com.example.friendapplication.KenyaProducerDetailsActivity
import com.example.friendapplication.R
import com.example.friendapplication.TanzaniaProducerDetailsActivity
...
class TanzaniaProducerListAdapter  (var mContext: Context, var tanzaniaproducerList:List<TanzaniaProducer>):
    RecyclerView.Adapter<TanzaniaProducerListAdapter.ListViewHolder>()
{
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ListViewHolder {
        ...
        val v = inflater.inflate(R.layout.tanzania_producer_item,parent,false)
        return ListViewHolder(v)
    }

    override fun onBindViewHolder(holder: ListViewHolder, position: Int) {
        val newList = tanzaniaproducerList[position]
        ...
        holder.v.setOnClickListener {
            ...
            val mIntent = Intent(mContext, TanzaniaProducerDetailsActivity::class.java)
    ...
    override fun getItemCount(): Int = tanzaniaproducerList.size
}
