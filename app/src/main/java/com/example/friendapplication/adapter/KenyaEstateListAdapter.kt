...
import com.example.friendapplication.NigeriaEstateDetailsActivity
...
class KenyaEstateListAdapter  (var mContext: Context, var kenyaestateList:List<KenyaEstate>):
    RecyclerView.Adapter<KenyaEstateListAdapter.ListViewHolder>()
{
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ListViewHolder {
        ...
        val v = inflater.inflate(R.layout.kenya_estate_item,parent,false)
        return ListViewHolder(v)
    }

    override fun onBindViewHolder(holder: ListViewHolder, position: Int) {
        val newList = kenyaestateList[position]
        ...
        holder.v.setOnClickListener {
            ...
            val mIntent = Intent(mContext, KenyaEstateDetailsActivity::class.java)
    ...
    override fun getItemCount(): Int = kenyaestateList.size
}
