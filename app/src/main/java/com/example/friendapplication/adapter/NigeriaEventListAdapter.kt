...
import com.example.friendapplication.EventDetailsActivity
import com.example.friendapplication.NigeriaEventDetailsActivity
...
class NigeriaEventListAdapter (var mContext: Context, var nigeriaeventList:List<NigeriaEvent>):
    RecyclerView.Adapter<NigeriaEventListAdapter.ListViewHolder>()
{
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ListViewHolder {
        ...
        val v = inflater.inflate(R.layout.nigeria_event_item,parent,false)
        return ListViewHolder(v)
    }

    override fun onBindViewHolder(holder: ListViewHolder, position: Int) {
        val newList = nigeriaeventList[position]
        ...
        holder.v.setOnClickListener {
            ...
            val mIntent = Intent(mContext, NigeriaEventDetailsActivity::class.java)
    ...
    override fun getItemCount(): Int = nigeriaeventList.size
}
