...
class NigeriaFoundListAdapter (var mContext: Context, var nigeriafoundList:List<NigeriaFound>):
    RecyclerView.Adapter<NigeriaFoundListAdapter.ListViewHolder>()
{
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ListViewHolder {
        ...
        val v = inflater.inflate(R.layout.nigeria_found_item,parent,false)
        return ListViewHolder(v)
    }

    override fun onBindViewHolder(holder: ListViewHolder, position: Int) {
        val newList = nigeriafoundList[position]
        ...
        holder.v.setOnClickListener {
            ...
            val mIntent = Intent(mContext, NigeriaFoundDetailsActivity::class.java)
    ...
    override fun getItemCount(): Int = nigeriafoundList.size
}
