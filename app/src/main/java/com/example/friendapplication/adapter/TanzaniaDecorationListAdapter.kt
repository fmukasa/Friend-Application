...
import com.example.friendapplication.KenyaDecorationDetailsActivity
import com.example.friendapplication.R
import com.example.friendapplication.TanzaniaDecorationDetailsActivity
...
class TanzaniaDecorationListAdapter (var mContext: Context,
                                     var tanzaniadecorationList:List<TanzaniaDecoration>):
    RecyclerView.Adapter<TanzaniaDecorationListAdapter.ListViewHolder>()
{
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ListViewHolder {
        ...
        val v = inflater.inflate(R.layout.tanzania_decoration_item,parent,false)
        return ListViewHolder(v)
    }

    override fun onBindViewHolder(holder: ListViewHolder, position: Int) {
        val newList = tanzaniadecorationList[position]
        ...
        holder.v.setOnClickListener {
            ...
            val mIntent = Intent(mContext, TanzaniaDecorationDetailsActivity::class.java)
    ...
    override fun getItemCount(): Int = tanzaniadecorationList.size
}
