...
import com.example.friendapplication.TanzaniaDirectorDetailsActivity
...
class TanzaniaDirectorListAdapter (var mContext: Context, var tanzaniadirectorList:List<TanzaniaDirector>):
    RecyclerView.Adapter<TanzaniaDirectorListAdapter.ListViewHolder>()
{
    ...
    override fun onBindViewHolder(holder: ListViewHolder, position: Int) {
        val newList = tanzaniadirectorList[position]
        ...
        holder.v.setOnClickListener {
            ...
            val mIntent = Intent(mContext, TanzaniaDirectorDetailsActivity::class.java)
    ...
    override fun getItemCount(): Int = tanzaniadirectorList.size
}
