...
import com.example.friendapplication.NigeriaFoundDetailsActivity
...
class KenyaFoundListAdapter (var mContext: Context, var kenyafoundList:List<KenyaFound>):
    RecyclerView.Adapter<KenyaFoundListAdapter.ListViewHolder>()
{
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ListViewHolder {
        ...
        val v = inflater.inflate(R.layout.kenya_found_item,parent,false)
        return ListViewHolder(v)
    }

    override fun onBindViewHolder(holder: ListViewHolder, position: Int) {
        val newList = kenyafoundList[position]
        ...
        holder.v.setOnClickListener {
            ...
            val mIntent = Intent(mContext, KenyaFoundDetailsActivity::class.java)
    ...
    override fun getItemCount(): Int = kenyafoundList.size
}
