...
import com.example.friendapplication.NigeriaDecorationDetailsActivity
...
class KenyaDecorationListAdapter (var mContext: Context,
                                  var kenyadecorationList:List<KenyaDecoration>):
    RecyclerView.Adapter<KenyaDecorationListAdapter.ListViewHolder>()
{
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ListViewHolder {
        ...
        val v = inflater.inflate(R.layout.kenya_decoration_item,parent,false)
        return ListViewHolder(v)
    }

    override fun onBindViewHolder(holder: ListViewHolder, position: Int) {
        val newList = kenyadecorationList[position]
        ...
        holder.v.setOnClickListener {
            ...
            val mIntent = Intent(mContext, KenyaDecorationDetailsActivity::class.java)
    ...
    override fun getItemCount(): Int = kenyadecorationList.size
}
