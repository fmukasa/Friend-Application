...
import com.example.friendapplication.KenyaPromoterDetailsActivity
import com.example.friendapplication.R
import com.example.friendapplication.TanzaniaPromoterDetailsActivity
...
class TanzaniaPromoterListAdapter (var mContext: Context, var tanzaniapromoterList:List<TanzaniaPromoter>):
    RecyclerView.Adapter<TanzaniaPromoterListAdapter.ListViewHolder>()
{
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ListViewHolder {
        ...
        val v = inflater.inflate(R.layout.tanzania_promoter_item,parent,false)
        return ListViewHolder(v)
    }

    override fun onBindViewHolder(holder: ListViewHolder, position: Int) {
        val newList = tanzaniapromoterList[position]
        ...
        holder.v.setOnClickListener {
            ...
            val mIntent = Intent(mContext, TanzaniaPromoterDetailsActivity::class.java)
    ...
    override fun getItemCount(): Int = tanzaniapromoterList.size
}
