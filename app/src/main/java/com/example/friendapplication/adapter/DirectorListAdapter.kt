...
import com.example.friendapplication.DirectorDetailsActivity
...
class DirectorListAdapter (var mContext: Context, var directorList:List<Director>):
    RecyclerView.Adapter<DirectorListAdapter.ListViewHolder>()
{
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ListViewHolder {
        ...
        val v = inflater.inflate(R.layout.director_item,parent,false)
        return ListViewHolder(v)
    }

    override fun onBindViewHolder(holder: ListViewHolder, position: Int) {
        val newList = directorList[position]
        ...
        holder.v.setOnClickListener {
            ...
            val mIntent = Intent(mContext, DirectorDetailsActivity::class.java)
    ...
    override fun getItemCount(): Int = directorList.size
}
