...
import com.example.friendapplication.KenyaDetailsActivity
import com.example.friendapplication.R
import com.example.friendapplication.TanzaniaDetailsActivity
import com.example.friendapplication.model.Kenya
import com.example.friendapplication.model.Tanzania
import com.example.friendapplication.uitel.loadImage

class TanzaniaListAdapter  (var mContext: Context, var tanzaniaList:List<Tanzania>):
    RecyclerView.Adapter<TanzaniaListAdapter.ListViewHolder>()
{
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ListViewHolder {
        ...
        val v = inflater.inflate(R.layout.tanzania_item,parent,false)
        return ListViewHolder(v)
    }

    override fun onBindViewHolder(holder: ListViewHolder, position: Int) {
        val newList = tanzaniaList[position]
        ...
        holder.v.setOnClickListener {
            ...
            val mIntent = Intent(mContext, TanzaniaDetailsActivity::class.java)
    ...
    override fun getItemCount(): Int = tanzaniaList.size
}
