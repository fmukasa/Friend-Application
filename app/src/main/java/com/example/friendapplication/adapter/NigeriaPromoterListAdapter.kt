...
class NigeriaPromoterListAdapter (var mContext: Context, var nigeriapromoterList:List<NigeriaPromoter>):
    RecyclerView.Adapter<NigeriaPromoterListAdapter.ListViewHolder>()
{
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ListViewHolder {
        ...
        val v = inflater.inflate(R.layout.nigeria_promoter_item,parent,false)
        return ListViewHolder(v)
    }

    override fun onBindViewHolder(holder: ListViewHolder, position: Int) {
        val newList = nigeriapromoterList[position]
        ...
        holder.v.setOnClickListener {
            ...
            val mIntent = Intent(mContext, NigeriaPromoterDetailsActivity::class.java)
    ...
    override fun getItemCount(): Int = nigeriapromoterList.size
}
