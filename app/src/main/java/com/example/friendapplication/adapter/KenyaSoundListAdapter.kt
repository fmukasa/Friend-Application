...
import com.example.friendapplication.NigeriaSoundDetailsActivity
...
class KenyaSoundListAdapter (var mContext: Context, var kenyasoundList:List<KenyaSound>):
    RecyclerView.Adapter<KenyaSoundListAdapter.ListViewHolder>()
{
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ListViewHolder {
        ...
        val v = inflater.inflate(R.layout.kenya_sound_item,parent,false)
        return ListViewHolder(v)
    }

    override fun onBindViewHolder(holder: ListViewHolder, position: Int) {
        val newList = kenyasoundList[position]
        ...
        holder.v.setOnClickListener {
            ...
            val mIntent = Intent(mContext, KenyaSoundDetailsActivity::class.java)
    ...
    override fun getItemCount(): Int = kenyasoundList.size
}
