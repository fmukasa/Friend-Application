...
class KenyaProducerListAdapter  (var mContext: Context, var kenyaproducerList:List<KenyaProducer>):
    RecyclerView.Adapter<KenyaProducerListAdapter.ListViewHolder>()
{
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ListViewHolder {
        ...
        val v = inflater.inflate(R.layout.kenya_producer_item,parent,false)
        return ListViewHolder(v)
    }

    override fun onBindViewHolder(holder: ListViewHolder, position: Int) {
        val newList = kenyaproducerList[position]
        ...
        holder.v.setOnClickListener {
            ...
            val mIntent = Intent(mContext, KenyaProducerDetailsActivity::class.java)
    ...
    override fun getItemCount(): Int = kenyaproducerList.size
}
