...
class ProducerListAdapter (var mContext: Context, var producerList:List<Producer>):
    RecyclerView.Adapter<ProducerListAdapter.ListViewHolder>()
{
    ...
    override fun onBindViewHolder(holder: ListViewHolder, position: Int) {
        val newList = producerList[position]
        ...
        holder.v.setOnClickListener {
            ...
            val mIntent = Intent(mContext, ProducerDetailsActivity::class.java)
