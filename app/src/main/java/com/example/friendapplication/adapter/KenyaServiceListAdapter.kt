...
import com.example.friendapplication.NigeriaServiceDetailsActivity
...
class KenyaServiceListAdapter (var mContext: Context, var kenyaserviceList:List<KenyaService>):
    RecyclerView.Adapter<KenyaServiceListAdapter.ListViewHolder>()
{
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ListViewHolder {
        ...
        val v = inflater.inflate(R.layout.kenya_service_item,parent,false)
        return ListViewHolder(v)
    }

    override fun onBindViewHolder(holder: ListViewHolder, position: Int) {
        val newList = kenyaserviceList[position]
        ...
        holder.v.setOnClickListener {
            ...
            val mIntent = Intent(mContext, KenyaServiceDetailsActivity::class.java)
    ...
    override fun getItemCount(): Int = kenyaserviceList.size
}
