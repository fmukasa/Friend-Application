...
class KenyaEventListAdapter (var mContext: Context, var kenyaeventList:List<KenyaEvent>):
    RecyclerView.Adapter<KenyaEventListAdapter.ListViewHolder>()
{
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ListViewHolder {
        ...
        val v = inflater.inflate(R.layout.kenya_event_item,parent,false)
        return ListViewHolder(v)
    }

    override fun onBindViewHolder(holder: ListViewHolder, position: Int) {
        val newList = kenyaeventList[position]
        ...
        holder.v.setOnClickListener {
            ...
            val mIntent = Intent(mContext, KenyaEventDetailsActivity::class.java)
    ...
    override fun getItemCount(): Int = kenyaeventList.size
}
