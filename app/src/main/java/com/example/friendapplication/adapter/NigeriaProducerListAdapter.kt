...
import com.example.friendapplication.NigeriaProducerDetailsActivity
import com.example.friendapplication.ProducerDetailsActivity
...
class NigeriaProducerListAdapter (var mContext: Context, var nigeriaproducerList:List<NigeriaProducer>):
    RecyclerView.Adapter<NigeriaProducerListAdapter.ListViewHolder>()
{
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ListViewHolder {
        ...
        val v = inflater.inflate(R.layout.nigeria_producer_item,parent,false)
        return ListViewHolder(v)
    }

    override fun onBindViewHolder(holder: ListViewHolder, position: Int) {
        val newList = nigeriaproducerList[position]
        ...
        holder.v.setOnClickListener {
            ...
            val mIntent = Intent(mContext, NigeriaProducerDetailsActivity::class.java)
    ...
    override fun getItemCount(): Int = nigeriaproducerList.size
}
