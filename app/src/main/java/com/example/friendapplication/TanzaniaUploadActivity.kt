...
class TanzaniaUploadActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_tanzannia_upload)
        ...
        mStorageRef = FirebaseStorage.getInstance().getReference("tanzanians_uploads")
        ...
        upLoadBtnTz.setOnClickListener {
            if (mUploadTask != null && mUploadTask!!.isInProgress) {
                Toast.makeText(this@TanzaniaUploadActivity,
    ...
    private fun uploadFile() {
        if (mImageUri != null){
            ...
            mUploadTask = fileReference.putFile(mImageUri!!)
                .addOnSuccessListener {
                    ...
                    handler.postDelayed(
                        ...
                        ,500)
                    Toast.makeText(this@TanzaniaUploadActivity, "File Upload Successful", Toast.LENGTH_SHORT).show()
                    val upload = Kenya(
                ...
                .addOnFailureListener { e->
                    progressBar.visibility = View.INVISIBLE
                    Toast.makeText(this@TanzaniaUploadActivity, e.message, Toast.LENGTH_SHORT).show()
                }
            ...
            Toast.makeText(this@TanzaniaUploadActivity,"You haven't selected any File", Toast.LENGTH_SHORT).show()
        }
    }

    private fun openImageActivity() {
        startActivity(Intent(this@TanzaniaUploadActivity, TanzaniaFoodActivity::class.java))
    }
}